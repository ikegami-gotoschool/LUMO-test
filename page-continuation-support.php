...
<div class="pageService _transition">
  <div class="mv _page pageService_mv pageServiceMv">
    <picture class="mv_thumbnail pageServiceMv_thumbnail">
      <source media="(max-width: 768px)" srcset="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/transition/mv_img_sp.png">
      <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/transition/mv_img.png" alt="キッチンで調理作業をする男性と女性">
    </picture>

    <div class="mv_content">
      <h1 class="mv_heading" data-entitle="SERVICE">就労継続支援<span class="mv_headingNote">（A型）</span></h1>
